...
<div class="top">
    <div class="wt1080">
        <div class="fl">
            <a href="index.do">首页</a>&emsp;|&emsp;请&emsp;<a href="skipLogin.do" style="color: #ff00c8">登陆</a>&emsp;或&emsp;<a href="skipReg.do">用户注册</a>&emsp;<a href="skipshopRetist.do">商家注册</a>
        </div>
        <div class="fr">
            <ul>
...
<div class="wt1080 header">
    <div class="logo fl"><a href="shopGoods.do?shopid=${shop.id}" style="font-size:28px;color:#ff00c8">${shop.realname}</a></div>
    ...
    <a class="my_shop fr" href="cartList.do">购物车
    <c:if test="${sessionScope.sessionmember ne null}">
