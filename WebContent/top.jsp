...
<div class="top">
    <div class="wt1080">
        ...
        <c:if test="${sessionScope.sessionmember eq null}">
            <a href="index.do">首页</a>&emsp;|&emsp;请&emsp;<a href="skipLogin.do" style="color: #ff00c8">登陆</a>
...
<div class="wt1080 header">
    <div class="logo fl"><a href="index.do" style="font-size:28px;color:#ff00c8">洛阳市鲜花网站</a></div>
...
<div class="nav">
    <div class="wt1080">
        <ul>
            ...
            <li><a href="newsLb.do"><span>新闻公告</span></a></li>
