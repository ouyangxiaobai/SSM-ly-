...
<div class="wt1080">
    <!----------------位置--------------------->
    <div class="place">
        当前位置：<span class="check"><a href="index.do" style="color:#ff00c8">首页</a>>>${product.productname}</span>
    </div>
    <!-------------商品详细----------------->
    <div class="property">
        <div class="left">
            ...
            <div class="pingjia">
                ...
                <div style="padding-left: 10px;">
                  ...
                  <input type="hidden" value="${product.id}" name="productid"/>
                    ...
                    <div style="margin-top: 15px;"><input type="submit" value="提交" style="width: 120px;height: 40px;color:white;background: #ff00c8;font-size:18px;border:0px;cursor:pointer"/></div>
                  </form>
                </div>
