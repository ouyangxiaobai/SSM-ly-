...
<div class="wt1080">
    ...
    <div class="my_order">
        ...
        <div class="place">
            <ul>
                <li class="current"><span>1</span><p>购物车</p></li>
                ...
                <c:forEach items="${ticketlist}" var="ticket">
                    <li onclick="sy('${ticket.id}')">
                        <div class="jj">
                            ...
                            <span class="guoqi" id="guoqi${ticket.id}" style="background:url('');border:1px solid #ff00c8; height: 40px;width: 40px;border-radius:40px 40px;line-height: 40px;background-color: #ff00c8;font-weight: bolder;display: none;">抵用</span>
